...
Class Soundcloud {
    ...
    /**
     * Public Method - This is the method users shoud use to access PUT Soundcloud api resources
     * @return object the response received from Soundcloud API
     * @access public
     */
    public function putResource($resource, $params = array()) {
        $url = $this->_buildUrl($resource, $params);

        // set cURL to PUT and add url
        $this->setCurlOptions(array(
    ...
    /**
     * Public Method - This is the method users shoud use to access DELETE Soundcloud api resources
     * @return object the response received from Soundcloud API
     * @access public
     */
    public function deleteResource($resource, $params = array()) {
        $url = $this->_buildUrl($resource);

        // set cURL to DELETE and add url
        $this->setCurlOptions(array(
